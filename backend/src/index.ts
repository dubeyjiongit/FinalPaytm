...
// Purely additive — changes nothing about how this file runs directly
// (`node backend/dist/index.js` / `npm start` still just calls app.listen()
// above exactly as before). This export is what lets a serverless host
// (Vercel's @vercel/node builder) pick up this same Express app as its
// request handler, instead of needing a second, separate copy of the app.
export default app;
